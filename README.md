...
Download and run the Exe and follow the instructions in the console.
The process will take some time, especially if you download a whole manga at once - the memory needed is also quite big suprisingly; Chainsaw Man is 5.5GB for example

The tool should work in all firefox based browsers but im not motivated enough to test it outside of that
